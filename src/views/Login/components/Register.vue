<script setup lang="ts">
  ...
  const { protocol, onProtocol } = useProtocol()
  ...
  <Motion :delay="100">
    <div class="w-[400px] bg-white p-4 rounded-xl">
      <el-form ref="formRef" :model="form" :rules="rules" size="large">
        ...
        <el-form-item>
          <el-checkbox v-model="protocol"> 我已仔细阅读并接受 </el-checkbox>
          <el-button link type="primary" @click="onProtocol"> 《隐私政策》 </el-button>
        </el-form-item>
        <el-form-item>
          <el-button class="w-full" type="primary" @click="register">确认</el-button>
        </el-form-item>
        <el-form-item>
